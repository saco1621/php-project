...
<tr>
<td width="67" id="first" align="center"><a href="#" onClick="Lmenu('Services')" onMouseOut="none">Services</a></td>
<td width="75" id="first" align="center"><a href="#" onClick="Lmenu('Food')" onMouseOut="none">Food/drinks</a></td>
...
function Lmenu(value){
	switch(value){
		case "Services":
			submenu.innerHTML="<a href='#'>Avaliablity</a>|<a href='#'>Toilet</a>|<a href='#'>Locker</a>";
			break;
		...
		case "About":
			submenu.innerHTML="<a href='#'>About Nevoda</a>|<a href='#'>About Nassjo central</a>|<a href='#'>about development</a>";
			break;
	}
